...
var task_descriptions = {
    ...
    'age': '&nbsp; &nbsp; This is the <strong>second part</strong> of <strong>Task 2</strong>. The target attribute for this part is <span style="font-weight: bold; color: red;">age</span>. The models are trained to modify the original person to <strong>60 years old</strong> without changing other attributes.',
